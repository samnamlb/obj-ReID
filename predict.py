...
def filter_existing_paths(dataset_root, paths):
    kept = []
    missing = 0
    for p in paths:
...
def main():
    ...
    query_paths   = filter_existing_paths(args.dataset_root, query_paths)
    gallery_paths = filter_existing_paths(args.dataset_root, gallery_paths)
